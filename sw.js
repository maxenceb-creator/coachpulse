const CACHE_NAME = 'coachpulse-v6-4-89-release';
...
const CORE_ASSETS = [
  ...
  './pages/coach-stats/match-entry.css', './pages/coach-stats/coachStatsConfig.js', './pages/coach-stats/heatmap-tooltips.css', './pages/coach-stats/heatmap-tooltips.js',
...
const NETWORK_FIRST_ASSETS = new Set(['./', './index.html', './app.js', './css/responsive.css', './manifest.json', './pages/tests-techniques.html', './pages/player-profile.html', './pages/player-profile/playerProfile.js', './pages/player-profile/playerProfileStats.js', './pages/player-profile/playerProfileRender.js']);
