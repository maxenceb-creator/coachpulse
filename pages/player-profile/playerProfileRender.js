(function(global){
  ...
  function renderMatchSummary(summary={}){
    ...
    <section class="match-history"><h3>Détail par match</h3>${table(['Date','Adversaire','Score','Temps','Postes','Buts','PD','Tirs C.','Récup.'], history, 'Aucun match sur cette période.')}</section>`;
  }
